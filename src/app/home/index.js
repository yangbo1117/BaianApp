...
class Home extends Component {
  ...
  render() {
    ...
    let isWP = window.location.href.indexOf('welcome') > -1 || window.location.href.indexOf('permission') > -1;
    let contentsPadding = isWP ? 0 : 15;
    let contentMargin = isWP ? 0 : 12;
      ...
      <Layout className="container">
        ...
        >
          <div className="logoContainer" style={{ overflow: 'hidden' }}>
            <Link to="/">
              <img src={logoImage} alt="组织结构管理" className="logo" />
            </Link>
            {this.state.collapsed ? (
              ''
            ) : (
              <span className="title" ref="memberTitle">
                组织结构管理
              </span>
            )}
          </div>
        ...
        <Layout className="ant-layout-ie9">
          <Header className="header">
            ...
            <div
              ...
              onMouseLeave={() => this.setState({ isShowUserOption: false })}
            >
              <div
                className="userInfo"
                onMouseEnter={() => this.setState({ isShowUserOption: true })}
              >
              ...
              {this.state.isShowUserOption && (
                <div className="userOption">
                  <button className="logout" onClick={this._resetPassword}>
                    重置密码
                  </button>
              ...
              {this.state.isShowResetPasswrod && (
                <WrappedUpdatePassword
                  ...
                  handleCancel={() =>
                    this.setState({ isShowResetPasswrod: false })
                  }
